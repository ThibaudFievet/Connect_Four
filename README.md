...
My goal is to take this specific project and rebuild it from scratch using my current professional standards, including:
* **Object-Oriented Programming (OOP)** instead of procedural functions.
* **Clean Architecture** and robust error handling.
* **A Graphical User Interface (GUI)** or a web interface.

## 📝 About The Original Code

This script runs a standard game of Connect 4 in the terminal.

### How to Run (Original Version)
